...
<footer class="footer" id="footer">
  <div class="container">
    ...
    <div class="footer__bottom">
      <p class="footer__copyright">&copy; <?php echo date('Y'); ?> RK Solutions. Todos los derechos reservados.</p>
    </div>
  </div>
</footer>
...
<a href="https://wa.me/34944050737?text=Hola%2C%20me%20interesa%20La%20Manzana" class="whatsapp-float" id="whatsappFloat" target="_blank" rel="noopener noreferrer" aria-label="Contactar por WhatsApp">
  ...
  <span class="whatsapp-float__tooltip">Chatea con nosotros</span>
</a>
